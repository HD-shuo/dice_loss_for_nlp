...
def re_sort_json(orign):
    ...
    """
    sorted_result = dict(sorted(ann["result"].items(), key=lambda item: item[1]['value']))
...
def json_transform(orign, target):
    ...
    cls = [['公司产品'], ['业务范围'], ['企业名称'], ['荣誉资质'], ['应用领域'], ['动态信息标题'],
            ['解决方案'], ['联系电话'], ['企业服务'], ['办公地址'], ['应用案例'],
              ['技术工艺'], ['产品介绍'], ['关键人员'], ['人员职称'], ['人员规模'],
                ['服务介绍'], ['人员详情'], ['附属园区'], ['技术介绍'], ['附属园区地址'], ['中标信息标题']]
    query = ['products of the company','business scope','the name of company','Honorary qualifications','application area',
             'Dynamic Information Title','solution','tel number','company services','the adress of company',
             'Application Cases','technology','introduction of products','Key personnel','Personnel Title',
             'staff size','services introduction','Personnel details','Affiliated park','Technology introduction','Affiliated park address',
             'Title of bid winning information']
